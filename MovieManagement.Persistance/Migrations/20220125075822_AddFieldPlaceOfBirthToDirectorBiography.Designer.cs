...
namespace MovieManagement.Persistance.Migrations
{
    ...
    [Migration("20220125075822_AddFieldPlaceOfBirthToDirectorBiography")]
    partial class AddFieldPlaceOfBirthToDirectorBiography
    {
            ...
            modelBuilder.Entity("MovieManagement.Domain.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 1, 25, 8, 58, 21, 737, DateTimeKind.Local).AddTicks(9035),
                            StatusId = 1
                        });
                });
